						...
						<div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="{{ route('single') }}">Mobile Phone1</a></h5>
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="{{ route('single') }}">Mobile Phone2</a></h5>
									<div class="simpleCart_shelfItem">
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="{{ route('single') }}">Mobile Phone3</a></h5>
									<div class="simpleCart_shelfItem">
						...
						<div role="tabpanel" class="tab-pane fade" id="audio" aria-labelledby="audio-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="{{ route('single') }}">Speakers</a></h5>
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="{{ route('single') }}">Headphones</a></h5>
									<div class="simpleCart_shelfItem">
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="{{ route('single') }}">Audio Player</a></h5>
									<div class="simpleCart_shelfItem">
						...
						<div role="tabpanel" class="tab-pane fade" id="video" aria-labelledby="video-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="{{ route('single') }}">Laptop</a></h5>
									<div class="simpleCart_shelfItem">
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="{{ route('single') }}">Notebook</a></h5>
									<div class="simpleCart_shelfItem">
						...
						<div role="tabpanel" class="tab-pane fade" id="tv" aria-labelledby="tv-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="{{ route('single') }}">Refrigerator</a></h5>
									<div class="simpleCart_shelfItem">
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="{{ route('single') }}">Washing Machine</a></h5>
									<div class="simpleCart_shelfItem">
						...
						<div role="tabpanel" class="tab-pane fade" id="kitchen" aria-labelledby="kitchen-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="{{ route('single') }}">Grinder</a></h5>
									<div class="simpleCart_shelfItem">
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<h5><a href="{{ route('single') }}">Water Purifier</a></h5>
									<div class="simpleCart_shelfItem">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						<div class="col-md-5 modal_body_left">
							<img src="{{ asset('images/11.png') }}" alt=" " class="img-responsive" />
						</div>
						<div class="col-md-7 modal_body_right">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						<div class="col-md-5 modal_body_left">
							<img src="{{ asset('images/14.png') }}" alt=" " class="img-responsive" />
						</div>
						<div class="col-md-7 modal_body_right">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						<div class="col-md-5 modal_body_left">
							<img src="{{ asset('images/36.png') }}" alt=" " class="img-responsive" />
						</div>
						<div class="col-md-7 modal_body_right">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						<div class="col-md-5 modal_body_left">
							<img src="{{ asset('images/37.png') }}" alt=" " class="img-responsive" />
						</div>
						<div class="col-md-7 modal_body_right">
			...
			<div class="agileinfo_new_products_grids">
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<h5><a href="{{ route('single') }}">Laptops</a></h5>
						<div class="simpleCart_shelfItem">
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<h5><a href="{{ route('single') }}">Black Phone</a></h5>
						<div class="simpleCart_shelfItem">
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<h5><a href="{{ route('single') }}">Kids Toy</a></h5>
						<div class="simpleCart_shelfItem">
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<h5><a href="{{ route('single') }}">Induction Stove</a></h5>
						<div class="simpleCart_shelfItem">
							<p><span>$280</span> <i class="item_price">$250</i></p>
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart">
