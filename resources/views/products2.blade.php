					...
					<div class="w3ls_mobiles_grid_left_grid">
						...
						<div class="w3ls_mobiles_grid_left_grid_sub">
							<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
							  <div class="panel panel-default">
								...
								<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
								  <div class="panel-body panel_text">
									<ul>
										<li><a href="{{ route('products') }}">Mobiles</a></li>
										<li><a href="{{ route('products1') }}">Laptop</a></li>
										<li><a href="{{ route('products2') }}">Tv</a></li>
										<li><a href="{{ route('products') }}">Wearables</a></li>
										<li><a href="{{ route('products2') }}">Refrigerator</a></li>
									</ul>
								  </div>
								</div>
							  </div>
							  <div class="panel panel-default">
								...
								<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
								   <div class="panel-body panel_text">
									<ul>
										<li><a href="{{ route('products2') }}">Grinder</a></li>
										<li><a href="{{ route('products2') }}">Heater</a></li>
										<li><a href="{{ route('products2') }}">Kid's Toys</a></li>
										<li><a href="{{ route('products2') }}">Filters</a></li>
							...
							<ul class="panel_bottom">
								<li><a href="{{ route('products') }}">Summer Store</a></li>
								<li><a href="{{ route('products') }}">Featured Brands</a></li>
								<li><a href="{{ route('products') }}">Today's Deals</a></li>
								<li><a href="{{ route('products') }}">Latest Watches</a></li>
							</ul>
						</div>
					</div>
					<div class="w3ls_mobiles_grid_left_grid">
				...
				<div class="col-md-8 w3ls_mobiles_grid_right">
					<div class="col-md-6 w3ls_mobiles_grid_right_left">
						<div class="w3ls_mobiles_grid_right_grid1">
							<img src="{{ asset('images/50.jpg') }}" alt=" " class="img-responsive" />
					...
					<div class="col-md-6 w3ls_mobiles_grid_right_left">
						<div class="w3ls_mobiles_grid_right_grid1">
							<img src="{{ asset('images/51.jpg') }}" alt=" " class="img-responsive" />
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									<img src="{{ asset('images/36.jpg') }}" alt=" " class="img-responsive" />
								...
								<h5><a href="{{ route('single') }}">Vacuum Cleaner</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									<img src="{{ asset('images/p12.jpg') }}" alt=" " class="img-responsive" /> 
									<img src="{{ asset('images/p13.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/p6.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/p13.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/p12.jpg') }}" alt=" " class="img-responsive" /> 
									<div class="w3_hs_bottom w3_hs_bottom_sub1">
										<ul>
								...
								<h5><a href="{{ route('single') }}">LED Tv</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									<img src="{{ asset('images/41.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/40.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/39.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/40.jpg') }} alt=" " class="img-responsive" />
									<img src="{{ asset('images/41.jpg') }}" alt=" " class="img-responsive" /> 
									<div class="w3_hs_bottom w3_hs_bottom_sub1">
								...
								<h5><a href="{{ route('single') }}">Coffee Maker</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									<img src="{{ asset('images/p13.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/p7.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/p12.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/p7.jpg') }}" alt=" " class="img-responsive" />
								...
								<h5><a href="{{ route('single') }}">Audio Speakers</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="{{ route('single') }}">Dry Iron </a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="{{ route('single') }}">Juicer Mixer</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									<img src="i{{ asset('images/37.jpg') }}" alt=" " class="img-responsive" />
									<img src="i{{ asset('images/40.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/39.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/40.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/37.jpg') }}" alt=" " class="img-responsive" /> 
									<div class="w3_hs_bottom w3_hs_bottom_sub1">
								...
								<h5><a href="{{ route('single') }}">Induction Cooktop </a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									...
									<img src="{{ asset('images/p11.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/p7.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/p11.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/35.jpg') }}" alt=" " class="img-responsive" /> 
									<div class="w3_hs_bottom w3_hs_bottom_sub1">
								...
								<h5><a href="{{ route('single') }}">Wireless Phone</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							<div class="hs-wrapper hs-wrapper3">
								<img src="{{ asset('images/34.jpg') }}" alt=" " class="img-responsive" />
								<img src="{{ asset('images/35.jpg') }}" alt=" " class="img-responsive" />
								<img src="{{ asset('images/27.jpg') }}" alt=" " class="img-responsive" />
								<img src="{{ asset('images/28.jpg') }}" alt=" " class="img-responsive" />
								<img src="{{ asset('images/37.jpg') }}" alt=" " class="img-responsive" /> 
							...
							<h5><a href="{{ route('single') }}">Kid's Toy</a></h5>
							<div class="simpleCart_shelfItem"> 
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							...
							<h5><a href="{{ route('single') }}">Microwave Oven</a></h5>
							<div class="simpleCart_shelfItem">
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							<div class="hs-wrapper hs-wrapper3">
								<img src="{{ asset('images/p3.jpg') }}" alt=" " class="img-responsive" />
								<img src="{{ asset('images/p5.jpg') }}" alt=" " class="img-responsive" />
							...
							<h5><a href="{{ route('single') }}">Music MP3 Player</a></h5>
							<div class="simpleCart_shelfItem">
								<p><span>$60</span> <i class="item_price">$58</i></p>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
