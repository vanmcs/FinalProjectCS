				...
				<div class="col-md-8 w3ls_mobiles_grid_right">
					<div class="col-md-6 w3ls_mobiles_grid_right_left">
						<div class="w3ls_mobiles_grid_right_grid1">
							<img src="{{ asset('images/46.jpg') }}" alt=" " class="img-responsive" />
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									...
									<img src="{{ asset('images/29.jpg') }}" alt=" " class="img-responsive" /> 
								...
								<h5><a href="{{ route('single') }}">Smart Phone</a></h5> 
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="{{ route('single') }}">Audio-speaker</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									<img src="{{ asset('images/30.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/28.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/26.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/27.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/29.jpg') }}" alt=" " class="img-responsive" /> 
									<div class="w3_hs_bottom w3_hs_bottom_sub1">
										<ul>
								...
								<h5><a href="{{ route('single') }}">Red Mobile</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="{{ route('single') }}">Headphone</a></h5>
								<div class="simpleCart_shelfItem">
									<p><span>$250</span> <i class="item_price">$245</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="{{ route('single') }}">Wireless Speaker</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="{{ route('single') }}">Asus Tablet</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="{{ route('single') }}">Golden Tablet</a></h5>
								<div class="simpleCart_shelfItem">
