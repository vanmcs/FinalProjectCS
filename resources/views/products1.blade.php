				...
				<div class="col-md-8 w3ls_mobiles_grid_right">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2"> 
									<img src="{{ asset('images/p8.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/p9.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/p10.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/p9.jpg') }}" alt=" " class="img-responsive" />
									<img src="{{ asset('images/p8.jpg') }}" alt=" " class="img-responsive" /> 
									<div class="w3_hs_bottom w3_hs_bottom_sub1">
										<ul>
				...
				<section>
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right">
							...
							<div class="rating">
								<div class="rating-left">
									<img src="i{{ asset('images/star-.png') }}" alt=" " class="img-responsive" />
								</div>
								<div class="rating-left">
									<img src="{{ asset('images/star-.png') }}" alt=" " class="img-responsive" />
								</div>
