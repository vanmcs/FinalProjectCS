			...
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="info"> 
						...
						<li><a href="{{ route('products') }}">Special Products</a></li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Category</h3>
					<ul class="info"> 
						...
						<li><a href="{{ route('products1') }}">Laptops</a></li>
						<li><a href="{{ route('products') }}">Purifiers</a></li>
						<li><a href="{{ route('products1') }}">Wearables</a></li>
						<li><a href="{{ route('products2') }}">Kitchen</a></li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Profile</h3>
